...
"5px"),d.find("ul.kolorMenu img.underThumb").css("vertical-align","top"),jQuery.each(d.find("ul.kolorMenu img.underThumb.mainLevel"),function(){jQuery(this).css("margin-top",a.item_thumb_max_height-jQuery(this).height()+"px")}))}function F(){for(var b='<div id="'+q+'" class="kolorMenuContainer" style="position:absolute;z-index:'+a.zorder+';"><div class="kolorMenuMain"><ul class="kolorMenu">',c=p.k().size(),d=m,f=0,e=m,i=0;i<c;i++){var d=p.k().get(i),f=d.h().size(),h=0;switch(a.position){case KolorMenu.a.f:case KolorMenu.a.i:case KolorMenu.a.j:h=
i;break;default:h=c-i}if(d.p()){b+='<li class="kolorMenuItem" style="z-index:'+h+';">';b+='<p id="'+d.getName()+'" class="'+d.t()+'">';if(("left"==a.text_align||"top"==a.text_align)&&""!=d.g())b+="<span class='mainLevel"+("top"==a.text_align&&""!=d.e()?" overThumb":"")+"'"+("left"==a.text_align&&""!=d.e()?" style='margin-right:10px;'":"")+">"+d.g()+"</span>";""!=d.e()&&(b+='<img src="'+d.e()+'" class="mainLevel'+("top"==a.text_align?" overThumb":"")+("bottom"==a.text_align?" underThumb":"")+'" alt="'+
d.g()+'" />');if(("right"==a.text_align||"bottom"==a.text_align)&&""!=d.g())b+="<span class='mainLevel"+("bottom"==a.text_align&&""!=d.e()?" underThumb":"")+"'"+("right"==a.text_align&&""!=d.e()?" style='margin-left:10px;'":"")+">"+d.g()+"</span>";b+="</p>";b+='<ul class="kolorMenuGroup">';d.C(k)}for(var j=0;j<f;j++){var e=d.h().get(j),l="subLevel";!d.p()&&1==f&&(e.C(k),l="mainLevel");b+='<li class="kolorMenuItem" style="z-index:'+h+';">';b+='<p id="'+e.getName()+'" class="'+e.t()+'">';if(("left"==
a.text_align||"top"==a.text_align)&&""!=e.g())b+="<span class='"+l+("top"==a.text_align&&""!=e.e()?" overThumb":"")+"'"+("left"==a.text_align&&""!=e.e()?" style='margin-right:10px;'":"")+">"+e.g()+"</span>";""!=e.e()&&(b+='<img src="'+e.e()+'" class="'+l+("top"==a.text_align?" overThumb":"")+("bottom"==a.text_align?" underThumb":"")+'" alt="'+e.g()+'" />');if(("right"==a.text_align||"bottom"==a.text_align)&&""!=e.g())b+="<span class='"+l+""+("bottom"==a.text_align&&""!=e.e()?" underThumb":"")+"'"+
("right"==a.text_align&&""!=e.e()?" style='margin-left:10px;'":"")+">"+e.g()+"</span>";b+="</p>";b+="</li>"}d.p()&&(b+="</ul></li>")}jQuery("#"+o).prepend(b+"</ul></div></div>")}var a={position:KolorMenu.a.q,orientation:KolorMenu.b.c,sub_orientation:KolorMenu.b.d,margin_x:8,margin_y:8,margins_on_items:n,margins_both:n,background_color:"b3b3b3",background_alpha:0.4,border_color:"ffffff",border_alpha:1,border_width:0,border_style:KolorMenu.u.NONE,border_radius:7,use_out_effect:k,item_out_bg_color:"4d4d4d",
item_out_bg_alpha:1,item_out_border_color:"424542",item_out_border_alpha:1,item_out_border_width:0,item_out_border_style:KolorMenu.u.NONE,item_out_border_radius:7,item_out_font_family:KolorMenu.F.D.value,item_out_font_color:"ffffff",item_out_font_size:14,item_out_font_weight:KolorMenu.H.o,item_out_font_style:KolorMenu.G.o,item_out_font_decoration:KolorMenu.I.NONE,use_hover_effect:k,item_hover_bg_color:"575757",item_hover_bg_alpha:1,item_hover_border_color:"424542",item_hover_border_alpha:1,item_hover_border_width:0,
item_hover_border_style:KolorMenu.u.NONE,item_hover_border_radius:7,item_hover_font_family:KolorMenu.F.D.value,item_hover_font_color:"ffffff",item_hover_font_size:14,item_hover_font_weight:KolorMenu.H.o,item_hover_font_style:KolorMenu.G.o,item_hover_font_decoration:KolorMenu.I.NONE,item_selected_color:"",item_selected_alpha:1,open_callback:n,text_align:"right",force_font_menu:n,force_font_menu_color:"",force_font_menu_family:"",force_font_menu_size:"",force_font_menu_weight:"",force_font_menu_style:"",
force_font_menu_decoration:"",force_font_submenu:n,force_font_submenu_color:"",force_font_submenu_family:"",force_font_submenu_size:"",force_font_submenu_weight:"",force_font_submenu_style:"",force_font_submenu_decoration:"",item_thumb_max_width:400,item_thumb_max_height:200,item_spacer:5,full_size:k,zorder:0},h=0,l=0,z=n,B=new ktools.Collection,d=m,C=n,p=this,D=n,E=n,A=n;this.setReady=this.Y=function(a){D=a};this.isReady=this.isReady=function(){return D};this.getKolorMenuGroups=this.k=function(){return B};
this.addKolorMenuGroup=this.K=function(a){B.add(a)};this.setKolorMenuOptions=this.U=function(b){a=jQuery.extend(a,b)};this.getKolorMenuOptions=this.O=function(){return a};this.openKolorMenu=this.R=function(){if(!E){ktools.Device.isTouch()||jQuery("<style type='text/css'>ul.kolorMenu li:hover>*{display:block;}</style>").appendTo("head");F();d=jQuery("#"+q);d.css("top","9999px");d.css("left","9999px");var b=d.find(".kolorMenu li>p>img"),c=0;0==b.length?(A=k,p.r()):(b.bind("load",function(){c++;b.length==
c&&(A=k,p.r())}),b.bind("error",function(){c++}));C||(jQuery(window).bind("resize",r),C=k);a.open_callback&&ktools.Code.eval(a.open_callback);E=k}};this.applyAll=this.r=function(){h=0==h?jQuery(window).width():kolorBrowserDetect.isIE()&&11<=kolorBrowserDetect.getInternetExplorerVersion()&&document.msFullscreenElement!=m?document.getElementById(o).clientWidth:jQuery("#"+o).width();l=0==l?jQuery(window).height():kolorBrowserDetect.isIE()&&11<=kolorBrowserDetect.getInternetExplorerVersion()&&document.msFullscreenElement!=
m?document.getElementById(o).clientHeight:jQuery("#"+o).height();t(d.find(".kolorMenuMain"),a);v();var b=d.find(".kolorMenuMain").children().find("ul");d.css("top","");d.css("right","");d.css("bottom","");d.css("left","");switch(a.orientation){case KolorMenu.b.d:d.find(".kolorMenuMain").css("display","block").css("padding","0 "+a.item_spacer+"px "+a.item_spacer+"px");d.find(".kolorMenu>li").css("float","none").css("padding",a.item_spacer+"px 0 0 0");a.full_size&&w();break;case KolorMenu.b.c:"Explorer"==
kolorBrowserDetect.browser&&7>kolorBrowserDetect.version?d.find(".kolorMenuMain").css("display","inline").css("zoom",1).css("padding","0 "+a.item_spacer+"px 0 0"):d.find(".kolorMenuMain").css("display","inline-block").css("padding","0 "+a.item_spacer+"px 0 0"),d.find(".kolorMenu>li").css("float","left").css("margin",a.item_spacer+"px 0 "+a.item_spacer+"px "+a.item_spacer+"px"),("left"==a.text_align||"right"==a.text_align)&&s(d.find(".kolorMenu")),a.full_size&&x()}switch(a.sub_orientation){case KolorMenu.b.d:b.css("padding",
"0 "+a.item_spacer+"px");b.find(">li").css("display","block").css("margin",a.item_spacer+"px 0 0");break;case KolorMenu.b.c:b.css("padding","0"),"Explorer"==kolorBrowserDetect.browser&&7>kolorBrowserDetect.version?b.find(">li").css("display","inline").css("zoom",1).css("margin",a.item_spacer+"px 0 0 "+a.item_spacer+"px"):kolorBrowserDetect.isMobileSafari()?b.find(">li").css("display","inline-block").css("margin",a.item_spacer+"px 0 "+a.item_spacer+"px "+a.item_spacer+"px"):b.find(">li").css("display",
"inline-block").css("margin",a.item_spacer+"px 0 0 "+a.item_spacer+"px")}switch(a.position){case KolorMenu.a.q:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("left",a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&d.css("top",a.margin_y+"px");break;case KolorMenu.a.w:a.margins_on_items?a.margins_on_items&&a.orientation==KolorMenu.b.d&&d.css("left",(h-d.width())/2+a.margin_x+"px"):a.full_size&&a.orientation==KolorMenu.b.c?d.css("left",a.margin_x):d.css("left",(h-d.width())/
2+a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&d.css("top",a.margin_y+"px");break;case KolorMenu.a.n:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("right",a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&d.css("top",a.margin_y+"px");break;case KolorMenu.a.m:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("right",a.margin_x+"px");a.orientation==KolorMenu.b.d?a.margins_on_items||d.css("top",(l-d.height())/2+a.margin_y+"px"):d.css("top",
(l-d.height())/2+a.margin_y+"px");break;case KolorMenu.a.f:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("right",a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&d.css("bottom",a.margin_y+"px");a.orientation==KolorMenu.b.c&&"inline-block"==d.find(".kolorMenuMain").css("display")&&d.find(".kolorMenuMain").css("vertical-align","bottom");break;case KolorMenu.a.i:a.margins_on_items?a.margins_on_items&&a.orientation==KolorMenu.b.d&&d.css("left",(h-d.width())/2+a.margin_x+
"px"):a.full_size&&a.orientation==KolorMenu.b.c?d.css("left",a.margin_x+"px"):d.css("left",(h-d.width())/2+a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&d.css("bottom",a.margin_y+"px");a.orientation==KolorMenu.b.c&&"inline-block"==d.find(".kolorMenuMain").css("display")&&d.find(".kolorMenuMain").css("vertical-align","bottom");break;case KolorMenu.a.j:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("left",a.margin_x+"px");(!a.margins_on_items||a.orientation!=KolorMenu.b.d)&&
d.css("bottom",a.margin_y+"px");a.orientation==KolorMenu.b.c&&"inline-block"==d.find(".kolorMenuMain").css("display")&&d.find(".kolorMenuMain").css("vertical-align","bottom");break;case KolorMenu.a.v:(!a.margins_on_items||a.orientation!=KolorMenu.b.c)&&d.css("left",a.margin_x+"px"),a.orientation==KolorMenu.b.d?a.margins_on_items||d.css("top",(l-d.height())/2+a.margin_y+"px"):d.css("top",(l-d.height())/2+a.margin_y+"px")}a.orientation==KolorMenu.b.d?y():u();if(""!=a.item_selected_color){var b=ktools.Color.hex2rgb(a.item_selected_color),
c=document.createElement("style");c.type="text/css";"Explorer"==kolorBrowserDetect.browser&&9>kolorBrowserDetect.version?c.styleSheet.cssText="#"+q+" .menuSelected { background-color: rgb("+b[0]+","+b[1]+","+b[2]+") !important; }":"Explorer"==kolorBrowserDetect.browser&&10>kolorBrowserDetect.version?c.styleSheet.cssText="#"+q+" .menuSelected { background-color: rgba("+b[0]+","+b[1]+","+b[2]+","+a.item_selected_alpha+") !important; }":c.innerHTML="#"+q+" .menuSelected { background-color: rgba("+b[0]+
","+b[1]+","+b[2]+","+a.item_selected_alpha+") !important; }";document.getElementsByTagName("head")[0].appendChild(c)}j()};this.applyResetCSS=this.M=function(){var a=d.find(".kolorMenuMain").children().find("ul"),c=d.find("li.kolorMenuItem");d.find("ul").removeData();d.find("p").css("height","");d.find("p").css("line-height","");d.css("top","");d.css("right","");d.css("bottom","");d.css("left","");d.find(".kolorMenuMain").css("width","");d.find(".kolorMenuMain").css("height","");d.find(".kolorMenu").css("width",
"");d.find(".kolorMenu").css("padding-left","");c.css("margin","");c.css("padding","");a.css("top","");a.css("right","");a.css("bottom","");a.css("left","")};this.showKolorMenu=this.ba=function(){d.show()};this.hideKolorMenu=this.P=function(){d.hide()};this.changeSelectedItem=this.N=function(a){if(a&&a[0])for(var c=p.k().size(),a=a[0],d=0,f=m,e=0;e<c;e++){group=p.k().get(e);jQuery("p#"+group.getName()).removeClass("menuSelected");for(var d=group.h().size(),h=0;h<d;h++)f=group.h().get(h),f.t()==a?
(jQuery("p#"+group.getName()).addClass("menuSelected"),jQuery("p#"+f.getName()).addClass("menuSelected")):jQuery("p#"+f.getName()).removeClass("menuSelected")}}};KolorMenu.b={d:"vertical",c:"horizontal"};KolorMenu.a={q:"topleft",w:"top",n:"topright",m:"right",f:"bottomright",i:"bottom",j:"bottomleft",v:"left"};KolorMenu.u={Aa:"solid",ma:"dotted",la:"dashed",na:"double",pa:"groove",za:"ridge",sa:"inset",wa:"outset",NONE:"none"};KolorMenu.H={o:"normal",fa:"bold"};KolorMenu.G={o:"normal",ta:"italic"};
